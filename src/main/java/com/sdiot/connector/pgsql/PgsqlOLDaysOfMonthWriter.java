...
public class PgsqlOLDaysOfMonthWriter extends RichSinkFunction<Tuple3<String, String, Integer>> {
    private static final Logger logger = LoggerFactory.getLogger(PgsqlOLDaysOfMonthWriter.class);
...
//    private static final String dbPwd = "postgres";
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        statement.execute(SqlConstants.IU_OL_DAYS_OF_MONTH);
        statement.close();

        callableStatement = connection.prepareCall("{call f_iu_ol_days_of_month(?, ?, ?, ?)}");
...
//        }
    ...
    public void invoke(Tuple3<String, String, Integer> value, Context context) throws Exception {
        try {
            ...
            callableStatement.setString(2, value.f1);
            callableStatement.setInt(3, value.f2);
